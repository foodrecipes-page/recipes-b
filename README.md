...
Recipe cache shard for **[foodrecipes.page](https://foodrecipes.page)** — AI-generated recipes whose slug starts with **the letter 'b'**.
...
```
https://cdn.jsdelivr.net/gh/foodrecipes-page/recipes-b@main/recipes/<cuisine>/<diet>/<slug>.json
```
